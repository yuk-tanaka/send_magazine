 ...
 * Generated for Laravel 5.7.14 on 2018-11-28 17:06:18.
 *
...
namespace App\Services\Support\Facades { 
    ...
    class ImportCSV {
         ...
         * 
         *
         * @param \App\Services\ImportCSV\UploadedFile $file
         * @return \App\Services\ImportCSV\Collection 
         * @throws ImportedCSVException
         * @static 
         */ 
        public static function import($file)
        {
            return \App\Services\ImportCSV\ImportCSV::import($file);
        }
    ...
    class Magazine {
         ...
         * 
         *
         * @param \App\Services\Magazine\Collection $sends ['name', 'email']
         * @return \Magazine 
         * @static 
         */ 
        public static function to($sends)
        {
            return \App\Services\Magazine\Magazine::to($sends);
        }
        
        /**
         * 
         *
         * @param \App\Services\Magazine\Carbon $sendAt
         * @param string $title
         ...
         * @static 
         */ 
        public static function send($sendAt, $title, $description, $footer)
        {
            return \App\Services\Magazine\Magazine::send($sendAt, $title, $description, $footer);
        }
...
namespace  { 
    ...
    class ImportCSV extends \App\Services\Support\Facades\ImportCSV {}

    class Magazine extends \App\Services\Support\Facades\Magazine {}
